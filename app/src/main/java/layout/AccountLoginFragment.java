 ...
 * {@link AccountLoginFragment.OnFragmentInteractionListener} interface
...
public class AccountLoginFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // button
        Button btn = (Button) v.findViewById(R.id.badaboom);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String[] newItem = {emailInput, passwordInput};
