package com.backslash.multispinner;
...
/**
 * Created by ! on 6/4/2017.
 */

/*
* multispinner search by https://github.com/pratikbutani/MultiSelectSpinner
* */
public class MultiSpinnerSearch extends AppCompatSpinner implements DialogInterface.OnCancelListener {
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            //even color then odd color
            final int backgroundColor = (position%2 == 0) ? R.color.translucent : R.color.translucent;
            ...
            //if checked, set these colors
            if (data.isSelected()) {
                holder.textView.setTypeface(null, Typeface.BOLD);
                holder.textView.setTextColor(Color.WHITE);
                holder.checkBox.setBackgroundColor(Color.DKGRAY);
                convertView.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.backslashLight));
            }
            //unchecked set these colors
            else {
